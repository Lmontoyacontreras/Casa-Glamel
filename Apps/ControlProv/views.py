...
class Factura_Proveedor_Ingresar(LoginRequiredMixin,CreateView):
    ...
    login_url = '/'
    template_name = 'ModuloAdmin/ControlTemplate/FacturaTemaplete/factura_proveedor_form.html'
...
class Pedido_Ingresar(LoginRequiredMixin,DetailView):
    model = Factura_Provedor
    login_url = '/'
    template_name = 'ModuloAdmin/ControlTemplate/PedidoTemplate/pedido_form.html'
...
class Factura_Proveedor_Lista(LoginRequiredMixin,ListView):
    ...
    template_name = 'ModuloAdmin/ControlTemplate/FacturaTemaplete/factura_proveedor_list.html'
...
class Factura_Proveedor_Detail(LoginRequiredMixin,DetailView):
    ...
    login_url = '/'
    context_object_name = 'factura_proveedor'
    template_name = 'ModuloAdmin/ControlTemplate/FacturaTemaplete/factura_proveedor_detail.html'
...
class Pedido_Eliminar(DetailView):
...
class Factura_Eliminar(DeleteView):
    model = Factura_Provedor
    context_object_name = 'factura_proveedor'
    template_name = 'ModuloAdmin/ControlTemplate/FacturaTemaplete/factura_proveedor_confirm_delete.html'
    success_url = reverse_lazy('ControlProv:Factura_Proveedor_Lista')

class Factura_Modificar(UpdateView):
    template_name = 'ModuloAdmin/ControlTemplate/FacturaTemaplete/factura_proveedor_form.html'
    form_class = Factura_Provedor_Form
    model = Factura_Provedor